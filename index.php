...
<title>Juan Pablo Paredes</title>
							...
							<div class="content hero">
								<div class="inner_content">
									...
									<div class="name_holder">
										<h3>JUAN PABLO <span>PAREDES</span></h3>
									</div>
								...
								<div class="author_wrap">
									...
									<div class="rightbox">
										...
										<div class="about_short_contact_wrap">
											<ul>
												<li>
													<span><label>Birthday:</label> 09.09.1986</span>
												</li>
												<li>
													<span><label>Age:</label> 33</span>
												</li>
												<li>
													<span><label>City:</label> Quito, Ecuador</span>
												</li>
												<li>
													<span><label>Interests:</label> Reading, New Languages</span>
												</li>
												<li>
													<span><label>Study:</label> ESPOCH</span>
												</li>
												<li>
													<span><label>Degree:</label> Engineer</span>
												</li>
												<li>
													<span><label>Website:</label> <a href="#">www.juanpabloparedes.me</a></span>
												</li>
												<li>
													<span><label>Mail:</label> <a href="mailto:jpparedesm@gmail.com">jpparedesm&#64;gmail.com</a></span>
												</li>
												<li>
													<span><label>Phone:</label> <a href="#">+593 992007443</a></span>
												</li>
												<li>
									...
									<div class="progress_bar_wrap_total">
										<div class="arlo_tm_progress_wrap" data-size="small" data-round="c" data-strip="off">
											<div class="arlo_tm_progress" data-value="95" data-color="#000">
												<span><span class="label">Symfony - <span class="experience">7 years of experience</span></span><span class="number">95%</span></span>
											...
											<div class="arlo_tm_progress" data-value="85" data-color="#000">
												<span><span class="label">Css - <span class="experience">8 years of experience</span></span><span class="number">85%</span></span>
												<div class="arlo_tm_bar_bg"><div class="arlo_tm_bar_wrap"><div class="arlo_tm_bar"></div></div></div>
											</div>
											<div class="arlo_tm_progress" data-value="75" data-color="#000">
												<span><span class="label">HTML - <span class="experience">12 years of experience</span></span><span class="number">75%</span></span>
												<div class="arlo_tm_bar_bg"><div class="arlo_tm_bar_wrap"><div class="arlo_tm_bar"></div></div></div>
											</div>
											<div class="arlo_tm_progress" data-value="90" data-color="#000">
												<span><span class="label">Jquery - <span class="experience">10 years of experience</span></span><span class="number">90%</span></span>
												<div class="arlo_tm_bar_bg"><div class="arlo_tm_bar_wrap"><div class="arlo_tm_bar"></div></div></div>
											</div>
											<div class="arlo_tm_progress" data-value="90" data-color="#000">
												<span><span class="label">Blockchain Technologies - <span class="experience">2 years of experience</span></span><span class="number">70%</span></span>
												<div class="arlo_tm_bar_bg"><div class="arlo_tm_bar_wrap"><div class="arlo_tm_bar"></div></div></div>
											</div>
										</div>
									</div>
